...
CREATE TABLE `vendedor` (
  ...
  KEY `fk_vendedor_usuario1_idx` (`usuario`),
  CONSTRAINT `fk_vendedor_usuario1` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
